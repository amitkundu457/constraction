...
@section('action-btn')
    <div class="float-end">
        ...
        <div class="dropdown-menu project-filter-actions dropdown-steady" id="project_status">
            <a class="pl-4 dropdown-item filter-action filter-show-all active" href="#">{{ __('Show All') }}</a>
            @foreach (\App\Models\Project::$project_status as $key => $val)
                <a class="pl-4 dropdown-item filter-action" href="#"
            ...
            return {
                ...
                fetchSiteDetails() {
                    if (this.selectedSite) {
                        fetch(`/api/site-details/${this.selectedSite}`)
