                        ...
                        <div class="col-md-6">
                            @if ($project != null)
                                <div class="form-group" id="vender-box">
                                    ...
                                    <input type="text" class="form-control" name="" id="" value="{{ $project }}">
                                </div>
                            @endif
                            <div class="form-group" id="vender-box">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    <td width="25%" class="form-group pt-0">
                                        {{ Form::select('item', $product_services, '', ['class' => 'form-control select2 item ', 'data-url' => route('bill.product')]) }}
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="form-group">
                                        {{ Form::select('chart_account_id', $chartAccounts, '', ['class' => 'form-control select2 js-searchBox']) }}
                                    </td>
                                    <td class="form-group">
                                        <div class="input-group ">
