@if (isset($call))
    {{ Form::model($call, ['route' => ['leads.calls.update', $lead->id, $call->id], 'method' => 'PUT']) }}
@else
    {{ Form::open(['route' => ['leads.calls.store', $lead->id]]) }}
@endif
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-12 form-group">
            ...
            {{ Form::time('duration', null, ['class' => 'form-control', 'placeholder' => '00:35:20', 'step' => '2']) }}
        </div>
        <div class="col-12 form-group">
        ...
        <div class="col-12 form-group">
            ...
            {{ Form::textarea('call_result', null, ['class' => 'summernote-simple', 'id' => 'summernote']) }}
