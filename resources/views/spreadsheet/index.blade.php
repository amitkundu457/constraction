                    ...
                    <tbody>
                        ...
                        @foreach ($sheets as $sheet)
                            <tr>
                                ...
                                <td>{{ $sheet->title }} </td>
                                <td>{{ Carbon\Carbon::parse($sheet->created_at)->format('d M, y h:i A') }}</td>
                                <td class="text-end">
                                    <div class="" style="display: flex; justify-content: end">
                                        <a href="{{ route('sheet.edit', $sheet->id) }}" class="btn btn-sm btn-primary"><i
                                                class="ti ti-pencil"></i> </a>

                                        @if ($sheet->share()->where('sheet_id', $sheet->id)->exists())
                                            {!! Form::open([
                                                'method' => 'DELETE',
                                            ...
                                            {!! Form::close() !!}
                                            <a href="{{ route('sheet.share.show',$sheet->id) }}" class="btn btn-sm btn-info" style="margin-left: 0.5rem"><i
                                                class="fa fa-eye "></i> </a>
                                        @else
                                            <button class="btn btn-sm btn-secondary"
                                                data-bs-target="#share_{{ $sheet->id }}" data-bs-toggle="modal"
                                    ...
                                    <div class="modal custom-modal fade" id="share_{{ $sheet->id }}" role="dialog">
                                        <div class="modal-dialog modal-lg " role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-start">
                                                    <form action="{{ route('sheet.share', $sheet->id) }}" method="post" x-data="{type:1}">
                                                        @csrf
                                                        <div class="row my-2">
