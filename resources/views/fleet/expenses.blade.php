                    ...
                    <tbody>
                        ...
                        @foreach ($expenses as $expense)
                            <tr>
                                ...
                                <td>{{ $expense->vehicle->vehicleType->name . ' / ' . $expense->vehicle->number . ' - ' . $expense->vehicle->code }}
                                </td>
                                ...
                                <td>
                                    @if ($expense->type == 'income')
                                        <span class="badge bg-info font-medium"
                                            style="font-size: 13px;">{{ ucfirst($expense->type) }} <i class="ti ti-arrow-up"></i></span>
                                            
                                    @elseif($expense->type == 'expense')
                                        <span class="badge bg-danger font-medium"
                                            style="font-size: 13px;">{{ ucfirst($expense->type) }} <i class="ti ti-arrow-down"></i></span>
                                    @endif
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="" style="display: flex">
                                        <a data-bs-target="#edit_modal-{{ $expense->id }}" data-bs-toggle="modal"
                                        ...
                                        <a class="btn btn-sm btn-danger" style="margin-left: 0.5rem"
                                            ...
                                            data-bs-target="#delete_modal-{{ $expense->id }}"
                                            data-id="{{ $expense->id }}">
                                            <i class="ti ti-trash"></i>
                                        </a>

                                    </div>
                                    <div class="modal custom-modal fade" id="delete_modal-{{ $expense->id }}"
                                        role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('vehicle.expense.delete', $expense->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                    ...
                                    <div class="modal custom-modal fade text-start" id="edit_modal-{{ $expense->id }}"
                                        role="dialog">
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('vehicle.expense.update', $expense->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('put')
                                                        <div class="row">
                                                                ...
                                                                <select class="form-control" name="vehicle_id"
                                                                    ...
                                                                    @foreach ($vehicles as $vehicle)
                                                                        <option value="{{ $vehicle->id }}"
                                                                            @selected($expense->vehicle_id == $vehicle->id)>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea class="form-control" name="description" id="" rows="3">{{ $expense->description }}</textarea>
                                                            </div>
                                                        </div>
