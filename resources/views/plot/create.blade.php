...
@section('content')
    <form action="{{ route('plot.create') }}" class="mt-3" method="post" x-data="{ owner: null, getOwner(id) { fetch(`/plot/owner/${id}`).then((res) => res.json()).then((data) => this.owner = data.owner) } }"
