{{ Form::open(['route' => 'labour.store', 'method' => 'post','enctype'=>'multipart/form-data']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('adhaar', null, ['class' => 'form-control', 'placeholder' => __('Enter Adhaar No.'), 'required' => 'required']) }}
                @error('adhaar')
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('price', null, ['class' => 'form-control', 'placeholder' => __('Enter Rate'), 'required' => 'required']) }}
                @error('price')
