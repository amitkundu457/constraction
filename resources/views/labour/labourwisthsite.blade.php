...
@section('action-btn')
    <div class="float-end">
        ...
        @endif --}}
        @can('create user')
            <a href="#" data-url="{{ route('laboursitecreate') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
    ...
    <script>
        function filter(){
            return {
                ...
                labours:[],
                projects(){
                    fetch('/labourgrp/projects').then((res)=>res.json()).then((data)=>this.projects = data.projects)
                },
                labours(id){
                    if(id){
                        fetch(`/labourgrp/${id}/labours`).then((res)=>res.json()).then((data)=>this.labours = data.labours)
                    }
                }
            }
        }
