    ...
    <div class="navbar-content">
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                <!--------------------- Start Dashboard ----------------------------------->
                <li
                    class="dash-item dash-hasmenu {{ Request::route()->getName() == 'dashboard' ? 'active dash-trigger' : '' }}">
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                {{-- @if (Gate::check('manage leave') || Gate::check('manage attendance'))
                                    <li
                                        ...
                                        <a class="dash-link" href="#">{{ __('Leave Management ') }}<span
                                                ...
                                                <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : '' }}"
                                                    ...
                                                    <ul class="dash-submenu">
                                                        <li
                                                            ...
                                                            <a class="dash-link"
                                                                href="{{ route('attendanceemployee.index') }}">{{ __('Attandance') }}</a>
                                                        </li>
                                                        @can('create attendance')
                                                            ...
                                                            <li
                                                                class="dash-item {{ Request::route()->getName() == 'reports-monthly-attendance' ? 'active' : '' }}">
                                                                <a class="dash-link"
                                                                    href="{{ url('reports-monthly-attendance') }}">{{ __('  Attendance Report') }}</a>
                                                            </li>
                                                        @endcan
                                                    </ul>
                                                </li>
                                ...
                                @if (Gate::check('manage leave'))
                                    <li class="dash-item {{ request()->is('leave.index') ? 'active' : '' }}">
                                        <a class="dash-link"
                                        ...
                                        <ul class="dash-submenu">
                                            @can('manage attendance')
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'attendanceemployee.index' ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ route('attendanceemployee.index') }}">{{ __('Attendance') }}</a>
                                                </li>
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'attendanceemployee.bulkattendance' ? 'active' : '' }}">
                                                    <a class="dash-link"
                                            ...
                                            @can('manage timesheet')
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'timesheet-list' ? 'active' : '' }}">
                                                    <a class="dash-link"
                                                        href="{{ url('timesheet-list') }}">{{ __('Timesheet') }}</a>
                                                </li>
                                            @endcan
                            ...
                            @can('manage company policy')
                                ...
                                @if (Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking'))
                                    <li style="display:none"
                                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking' ? 'active dash-trigger' : '' }}"
                                ...
                                @can('manage event')
                                    <li style="display:none"
                                        class="dash-item {{ request()->is('event*') ? 'active' : '' }}">
                                        <a class="dash-link"
                                ...
                                @can('manage meeting')
                                    <li style="display:none"
                                        class="dash-item {{ request()->is('meeting*') ? 'active' : '' }}">
                                        <a class="dash-link"
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if (Gate::check('manage goal'))
                                <li style="display: none"
                                    class="dash-item {{ Request::segment(1) == 'goal' ? 'active' : '' }}">
                                    <a class="dash-link"
            ...
            <li
                ...
                <a href="#!" class="dash-link"><span class="dash-micon"><i
                        ...
                        style="12px">{{ __('Property Management') }}</span><span class="dash-arrow"><i
                            data-feather="chevron-right"></i></span></a>
                <ul class="dash-submenu">
                    @can('manage project')
                        <li
                            class="dash-item  {{ Request::segment(1) == 'Property' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : '' }}">
                            <a class="dash-link" href="{{ url('property') }}">{{ __('Property') }}</a>
                        </li>
                    @endcan
                    @can('manage project task')
                        <li class="dash-item {{ request()->is('deal/add*') ? 'active' : '' }}">
                            <a class="dash-link" href="{{ url('deal/add') }}">{{ __('Property Deals') }}</a>
                        </li>
                    @endcan
                    <li
                        class="dash-item  {{ Request::segment(1) == 'employee' ? 'active dash-trigger' : '' }}   ">
                        @if (\Auth::user()->type == 'Employee')
                            ...
                            <a class="dash-link"
                                href="{{ route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt($employee->id)) }}">{{ __('Employee') }}</a>
                        @else
                            <a href="{{ route('plot.index') }}" class="dash-link">
                                {{ __('Plots') }}
                            </a>
                        @endif
                    </li>
                    ...
                    @if (Gate::check('manage project task stage') || Gate::check('manage bug status'))
                        <li
                            class="dash-item dash-hasmenu {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active dash-trigger' : '' }}">
                            <a class="dash-link" href="#">{{ __('Property  Setup') }}<span
                                    class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu">
                                @can('manage project task stage')
                                    <li
                                        ...
                                        <a class="dash-link"
                                            href="{{ url('property-type') }}">{{ __('Property Type') }}</a>
                                    </li>
                                @endcan
                                @can('manage project task stage')
                                    <li
                                ...
                                @can('manage project task stage')
                                    <li
                                        class="dash-item  {{ Request::route()->getName() == 'project-task-stages.index' ? 'active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ url('property-unit') }}">{{ __('Property Unit') }}</a>
                                    </li>
                                @endcan
                                @can('manage project task stage')
                                    <li
            ...
            @if (Gate::check('manage project'))
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext">{{ __('Project Management') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu">
                        @can('manage project')
                            <li
                        ...
                        @can('manage bug report')
                            <li style="display: none"
                                class="dash-item {{ request()->is('bugs-report*') ? 'active' : '' }}">
        ...
        @if (Gate::check('manage product & service') || Gate::check('manage product & service'))
            <li
                class="dash-item dash-hasmenu {{ Request::segment(1) == 'vender' || Request::segment(1) == 'equipment' ? 'active dash-trigger' : '' }}">
                <a href="#!" class="dash-link ">
                    <span class="dash-micon"><i class="ti ti-backhoe"></i></span><span
                        class="dash-mtext">{{ __('Site Management') }}</span><span class="dash-arrow">
                ...
                <ul class="dash-submenu">
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if (Gate::check('manage product & service'))
                                <li class="dash-item {{ Request::segment(1) == 'productservice' ? 'active' : '' }}">
                                    <a href="{{ route('productservice.index') }}"
                                        class="dash-link">{{ __('Materials & Services') }}
                                    </a>
                                </li>
                            @endif
                            @if (Gate::check('manage product & service'))
                            ...
                            @if (Gate::check('manage vender'))
                                {{-- <li class="dash-item {{ Request::segment(1) == 'vender' ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('vender.index') }}">{{ __('Site Name') }}</a>
                                </li> --}}
                                <li class="dash-item {{ Request::segment(1) == 'company' ? 'active' : '' }}">
                                    <a class="dash-link" href="{{ url('company') }}">{{ __('Supplier') }}</a>
                                </li>
                            @endif
                            @can('manage purchase')
                                <li
                    ...
                    {{-- <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active dash-trigger' : '' }}">
                        <a class="dash-link" href="#">{{ __('Resources') }}<span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('manage project task')
                                <li class="dash-item {{ request()->is('taskboard*') ? 'active' : '' }}">
                    ...
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'equipments' || Request::segment(1) == 'equipment' ? 'active dash-trigger' : '' }}">
                        <a class="dash-link" href="#">{{ __('Equipment Management') }}<span
                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            <li class="dash-item {{ request()->is('equipments') ? 'active' : '' }}">
                                <a class="dash-link"
                            ...
                            {{-- <li class="dash-item {{ Request::segment(1) == 'equipment.register.index' ? 'active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('equipment.register.index') }}">{{ __('Register Equipment') }}</a>
                            </li> --}}
                            <li class="dash-item {{ Request::segment(1) == '' ? 'active' : '' }}">
                                <a class="dash-link"
                                    href="{{ route('equipment.quality.index') }}">{{ __('Verification Method') }}</a>
                ...
                <li
                    class="dash-item dash-hasmenu
                             ...
                             Request::route()->getName() == 'revenue'                           
                                 ...
                                 : '' }}">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-building-store"></i></span><span class="dash-mtext">{{ __('Sales ') }}
                        </span><span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="dash-submenu">
            ...
            @if (Gate::check('manage customer') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext">{{ __('Fleet Management ') }}
                        </span><span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="dash-submenu">
                        {{-- @can('manage pos') --}}
                        ...
                        <li
                            class="dash-item {{ Request::route()->getName() == 'vehicle-expenses.index' ? ' active' : '' }}">
                            <a class="dash-link"
                                href="{{ route('vehicle-expenses.index') }}">{{ __('Income & Expense') }}</a>
                        </li>
                        <li
                            class="dash-item {{ Request::route()->getName() == 'vehicle.availability' ? ' active' : '' }}"">
                            <a class="dash-link"
                                href="{{ route('vehicle.availability') }}">{{ __('Availability') }}</a>
                        </li>
                        {{-- <li
                            class="dash-item {{ Request::route()->getName() == 'pos.report' || Request::route()->getName() == 'pos.show' ? ' active' : '' }}">
                            <a class="dash-link" href="{{ __('#') }}">{{ __('Maintainance') }}</a>
                        </li> --}}
                        {{-- @endcan --}}
                        ...
                        {{-- <li
                            class="dash-item {{ Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' ? ' active' : '' }}">
                            <a class="dash-link" href="{{ route('pos.barcode') }}">{{ __('Hiring') }}</a>
                        </li> --}}
                        {{-- @endcan --}}
                        {{-- @can('manage pos') --}}
                        {{-- <li
                            class="dash-item {{ Request::route()->getName() == 'pos-print-setting' ? ' active' : '' }}">
                            <a class="dash-link"
                                href="{{ route('pos.print.setting') }}">{{ __('Profit / Loss') }}</a>
                        </li> --}}
                        <li
                            class="dash-item {{ Request::route()->getName() == 'vehicle.type.index' ? ' active' : '' }}">
                            <a class="dash-link"
                                href="{{ route('vehicle.type.index') }}">{{ __('Fleet Setup') }}</a>
                        </li>
                        {{-- @endcan --}}
                        {{-- @if (Gate::check('manage customer')) --}}
                        {{-- <li class="dash-item {{ Request::segment(1) == 'customer' ? 'active' : '' }}">
        ...
        <li
            class="dash-item dash-hasmenu
                             {{ Request::route()->getName() == 'food.product.index' ||
            ...
            <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-exchange"></i></span><span
                    class="dash-mtext">{{ __('Supply Chain Management') }}
                </span><span class="dash-arrow"><i data-feather="chevron-right"></i></span>
            </a>
            <ul class="dash-submenu">
                <li class="dash-item {{ Request::route()->getName() == 'food.product.index' ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('food.product.index') }}">{{ __('Product') }}</a>
                </li>
                <li class="dash-item {{ Request::route()->getName() == 'food.retailer.index' ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('food.retailer.index') }}">{{ __('Retailer') }}</a>
                </li>
                <li
                    class="dash-item {{ Request::route()->getName() == 'food.manufacturer.index' ? ' active' : '' }}">
                    <a class="dash-link"
                        href="{{ route('food.manufacturer.index') }}">{{ __('Manufacturer') }}</a>
                </li>
                <li class="dash-item {{ Request::route()->getName() == 'food.distributor.index' ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('food.distributor.index') }}">{{ __('Dristributor') }}</a>
                </li>
                <li class="dash-item {{ Request::route()->getName() == 'food.unit.index' ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('food.unit.index') }}">{{ __('Supply Setup') }}</a>
                </li>
            </ul>
        </li>
        <!--------------------- End Food Management ----------------------------------->
        ...
        <li style="display: none;" class="dash-item dash-hasmenu
            ...
            <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-flask"></i></span><span
                    class="dash-mtext">{{ __('Quality Control') }}
                </span><span class="dash-arrow"><i data-feather="chevron-right"></i></span>
            </a>
            <ul class="dash-submenu">
                <li class="dash-item">
                    <a class="dash-link" href="#{{-- route('food.product.index') --}}">{{ __('Quality Plans') }}</a>
                </li>
                <li class="dash-item ">
                    <a class="dash-link" href="{{-- route('food.retailer.index') --}}">{{ __('Quality Audits') }}</a>
                </li>
                {{-- <li class="dash-item ">
                            <a class="dash-link" href="{{ route('food.manufacturer.index') }}">{{ __('Inspections') }}</a>
                        </li>
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('food.distributor.index') }}">{{ __('Issues') }}</a>
                        </li>
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('food.unit.index') }}">{{ __('Reports') }}</a>
                        </li> --}}
            </ul>
        </li>
        <!--------------------- End Quality Control ----------------------------------->
        ...
        @if (\Auth::user()->type != 'super admin')
            ...
            <li style="display: none"
                class="dash-item dash-hasmenu {{ Request::segment(1) == 'chats' ? 'active' : '' }}">
