    ...
    <div class="row">
        @if (\Auth::user()->type != 'employee')
            <div class="form-group col-md-6 col-lg-6">
                ...
                {{ Form::select('complaint_from', $employees, null, ['class' => 'form-control  select', 'required' => 'required']) }}
            </div>
        @endif
        <div class="form-group col-md-6 col-lg-6">
            {{ Form::label('complaint_against', __('Complaint Against'), ['class' => 'form-label']) }}
            {{ Form::select('complaint_against', $employees, null, ['class' => 'form-control select']) }}
        </div>
        <div class="form-group col-md-6 col-lg-6">
        ...
        <div class="form-group col-md-6 col-lg-6">
            ...
            {{ Form::date('complaint_date', null, ['class' => 'form-control']) }}
        </div>
