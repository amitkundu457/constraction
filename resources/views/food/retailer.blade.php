...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Retailer') }}</li>
@endsection
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('food.retailer.destroy', $manu->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                    ...
                                    <div class="modal custom-modal fade text-start" id="edit_modal-{{ $manu->id }}"
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('food.retailer.update',$manu->id) }}" method="post">
                                                        @csrf
                                                        @method('put')
                                                        <div class=" row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-control" name="food_area_id"
                                                                    ...
                                                                    @foreach ($areas as $item)
                                                                        <option value="{{ $item->id }}" @selected($manu->food_area_id == $item->id)>
                                                                            {{ $item->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
        ...
        <div class="modal custom-modal fade" id="callstore" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('food.retailer.store') }}" method="post">
                            @csrf
                            <div class=" row">
                                <div class="form-group col-md-6">
                                    <label>Name <span class="text-danger">*</span></label>
