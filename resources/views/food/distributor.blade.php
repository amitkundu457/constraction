...
@section('page-title')
    {{ __('Manage Distributor') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('Distributor') }}</li>
@endsection
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('food.distributor.destroy', $manu->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                    ...
                                    <div class="modal custom-modal fade text-start" id="edit_modal-{{ $manu->id }}"
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('food.distributor.update',$manu->id) }}" method="post">
                                                        @csrf
                                                        @method('put')
                                                        <div class=" row">
        ...
        <div class="modal custom-modal fade" id="callstore" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('food.distributor.store') }}" method="post">
                            @csrf
                            <div class=" row">
                                <div class="form-group col-md-6">
                                    <label>Name <span class="text-danger">*</span></label>
