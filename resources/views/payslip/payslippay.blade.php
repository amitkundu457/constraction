                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-6">
                                        <form
                                            action="{{ url('payslip/paysalary/' . $payslip->employee_id . '/' . $payslip->salary_month) }}"
                                            method="POST"> @csrf
                                            <div class="form-group">
                                                ...
                                                <input hidden type="text" name="basic_salary"
                                                    value="{{ $payslip->net_payble }}">
                                                <input hidden type="text" name="employee_id"
