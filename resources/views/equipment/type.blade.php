...
@section('action-btn')
    <div class="float-end">
        @can('create constant tax')
            <a href="#" data-url="{{ route('equipment.type.create') }}" data-ajax-popup="true" data-title="{{__('Create Equipment Type')}}" data-bs-toggle="tooltip" title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                                    ...
                                    <td class="Action">
                                        ...
                                        @can('edit constant tax')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('equipment.type.edit',$type->id) }}" data-ajax-popup="true" data-title="{{__('Edit Equipment Type')}}" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                            ...
                                            @can('delete constant tax')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['equipment.type.destroy', $type->id],'id'=>'delete-form-'.$type->id]) !!}
