                                    ...
                                    <th>
                                        <div class="action-btn bg-primary ms-2">
                                            <a href="{{ route('project.bill', \Crypt::encrypt($bug->id)) }}"
                                                ...
                                                title="{{ __('Generate') }}" data-original-title="{{ __('Detail') }}">
                                                <i class="text-white ti ti-file-invoice"></i>
                                            </a>
                                        </div>
                                        <div class="action-btn bg-danger ms-2">
                                            <a href="#" data-url="{{ URL::to('leave/' . $bug->id . '/action') }}"
                                                data-size="lg" data-ajax-popup="true" data-title="{{ __('Leave Action') }}"
                                                class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip"
                                        ...
                                        <div class="action-btn bg-primary ms-2">
                                            <a href="#" data-url="{{ URL::to('leave/' . $bug->id . '/edit') }}"
                                                data-size="lg" data-ajax-popup="true" data-title="{{ __('Edit Leave') }}"
                                                class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip"
