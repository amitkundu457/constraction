...
@section('page-title')
    {{ __('Manage Property BHK') }}
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('Property BHK') }}</li>
@endsection
...
<script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.14.1/dist/cdn.min.js"></script>
    <div class="row">
        <div class="col-md-6">
            <form action="{{ url('property-bhk-store') }}" method="post" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="modal-dialog modal modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Property BHK {{ $amenity->id }}</h5>
                                                ...
                                                <div class="modal-body text-start">
                                                    <form action="{{ url('property-bhk-update', $amenity->id) }}"
                                                        method="post" >
                                                        @csrf
                                                        <div class="form-group">
                                                            <label>Name <span class="text-danger">*</span></label>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ url('property-bhk-delete', $amenity->id) }}"
                                                        method="post">
                                                        @method('delete')
                                                        @csrf
