                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                {{ Form::label('vender_id', __('Site'), ['class' => 'form-label']) }}
                                {{ Form::select('vender_id', $venders, $vendorId, ['class' => 'form-control select ', 'id' => 'Site', 'data-url' => route('bill.vender'), 'required' => 'required']) }}
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('warehouse_id', __('Account'), ['class' => 'form-label']) }}
                                        {{ Form::select('chart_expence_id', $expenseChartAccounts, null, ['class' => 'form-control select', 'required' => 'required']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
