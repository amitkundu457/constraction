...
@section('action-btn')
    <div class="float-end">
        ...
        @endif
        @can('create user')
            <a href="#" data-size="lg" data-url="{{ route('agents.create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card text-center card-2">
                                        ...
                                        <div class="btn-group card-option">
                                            {{-- @if($user->is_active == 1) --}}
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    {{-- @can('edit user') --}}
                                                        <a href="#!" data-size="lg" data-url="{{ route('users.edit',$agent->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Edit User')}}">
                                                    ...
                                                    {{-- @can('delete user') --}}
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['users.destroy', $agent['id']],'id'=>'delete-form-'.$agent['id']]) !!}
                            ...
                            <div class="card-body full-card">
                                ...
                                <h4 class=" mt-3 text-primary">{{ $agent->name }}</h4>
                                {{-- @if($user->delete_status==0)
                                    <h5 class="office-time mb-0">{{__('Soft Deleted')}}</h5>
                                @endif --}}
                                <small class="text-primary">{{ $agent->email }}</small>
                                <p></p>
