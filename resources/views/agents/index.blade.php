...
@section('action-btn')
    <div class="float-end">
        ...
        @endif --}}
        @can('create user')
            <a href="#" data-size="lg" data-url="{{ route('agents.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
                title="{{ __('Create Agent') }}" class="btn btn-sm btn-primary">
                ...
                <tbody>
                    ...
                    @foreach ($agents as $agent)
                        <tr>
                            ...
                            <td>{{ $agent->email }}</td>
                            <td>{{ $agent->contact }}</td>
                            <td>{{ $agent->property->count() . ' Properties' }}</td>
                            <td>{{ Carbon\Carbon::parse($agent->created_at)->format('d M, Y h:i A') }}</td>
                            <td>
                                <div class="" style="display: flex">
                                    <a href="#" data-size="lg" data-url="{{ route('agents.edit', $agent->id) }}"
