{{Form::open(array('url'=>'agents','method'=>'post'))}}
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {{Form::tel('contact',null,array('class'=>'form-control','placeholder'=>__('Enter Contact'),'required'=>'required'))}}
                @error('contact')
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {{Form::date('dob',null,array('class'=>'form-control','placeholder'=>__('Enter DOB'),'required'=>'required'))}}
                @error('dob')
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {{Form::text('pan',null,array('class'=>'form-control','placeholder'=>__('Enter Pan No'),'required'=>'required'))}}
                @error('pan')
