...
// Route::get('test', [DocumentController::class, 'index']);
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('company-store', [CompanyController::class, 'create']);
    ...
    Route::get('em-type', [EmployeeController::class, 'employeType']);
    Route::post('em-type-create', [EmployeeController::class, 'employeeCreate']);
    Route::post('em-type-update/{id}', [EmployeeController::class, 'employeeUpdate']);
    Route::get('em-type-delete/{id}', [EmployeeController::class, 'employeeDelete']);
    ...
    Route::get('document-index', [DocumentController::class, 'index']);
    Route::resource('document', DocumentController::class)->middleware(['auth', 'XSS']);
    Route::post('document-store', [DocumentController::class, 'store'])->middleware(['auth', 'XSS']);
    ...
    Route::post('payslip/paysalary/{id}/{date}', [PaySlipController::class, 'paysalary'])->name('payslip.paysalary')->middleware(['auth', 'XSS']);
    Route::get('payslip/payslip-pay/{id}/{date}', [PaySlipController::class, 'payslip_pdf']);
    ...
    Route::get('payslip/pdf/{id}/{m}', [PaySlipController::class, 'pdf'])->name('payslip.payslip')->middleware(['auth', 'XSS']);
    Route::get('payslip/payslippay/{id}/{m}', [PaySlipController::class, 'payslipPay'])->name('payslip.payslippay')->middleware(['auth', 'XSS']);
    ...
    Route::get('attendanceemployee/attendance/report', [AttendanceEmployeeController::class, 'AttandeceReport'])->name('attendanceemployee.report')->middleware(['auth', 'XSS']);
    ...
    Route::get('/clients/{id}/details', [VenderController::class, 'getClientDetails']);
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('deals-property', [App\Http\Controllers\DealPropertyController::class, 'DealStore']);
            Route::post('deal-store', [App\Http\Controllers\DealPropertyController::class, 'DealStoreacrion']);
            ...
            Route::post('property-type-update/{id}', [PropertyController::class, 'propertyTypeUpdate']);
            Route::get('property-type-delete/{id}', [PropertyController::class, 'propertytypeDelete']);

            Route::get('property-contruct', [PropertyController::class, 'propertyContruct']);
            Route::post('property-contruct-store', [PropertyController::class, 'propertyContractStore']);
            Route::post('property-contruct-update/{id}', [PropertyController::class, 'propertyContractUpdate']);
            Route::get('property-contruct-delete/{id}', [PropertyController::class, 'propertyContractDelete']);



            Route::get('property-unit', [PropertyController::class, 'propertyunit']);
            Route::post('property-unit-store', [PropertyController::class, 'propertyUnitStore']);
            Route::post('property-unit-update/{id}', [PropertyController::class, 'propertyUnitUpdate']);
            Route::get('property-unit-delete/{id}', [PropertyController::class, 'propertyUnitDelete']);
            ...
            Route::get('property-photo-delete/{id}', [PropertyController::class, 'propertyphotoDelete']);


            Route::get('property-document/{id}', [PropertyController::class, 'propertydocument']);
            Route::post('property-document-store', [PropertyController::class, 'propertydocumentStore']);

            Route::get('property-document-delete/{id}', [PropertyController::class, 'propertyphotoDelete']);
            Route::get('property-document-download/{id}', [PropertyController::class, 'download']);


            Route::get('payment-plan', [DealPropertyController::class, 'paymentplansIndex']);
            Route::post('payment-plan-store', [DealPropertyController::class, 'paymentplansStore']);
            Route::post('payment-plan-update/{id}', [DealPropertyController::class, 'paymentplansUpdate']);
            Route::get('payment-plan-delete/{id}', [DealPropertyController::class, 'paymentplansDelete']);


            Route::get('deal/add', [DealPropertyController::class, 'DealStore'])->name('deal/add');
            Route::get('price/{id}', [DealPropertyController::class, 'getPrices']);


            Route::get('show-payment/{id}', [DealPropertyController::class, 'Installmentpaymntindex'])->name('show-payment');
            Route::post('show-payment-store', [DealPropertyController::class, 'storeInstallments']);
            Route::get('make-payment/{id}', [DealPropertyController::class, 'makePayment']);
            Route::post('make-payment-store', [DealPropertyController::class, 'PaymentStore']);
            Route::get('make-payment-history/{id}', [DealPropertyController::class, 'paymentHistory']);
        }
    );
