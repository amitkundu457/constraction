                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select name="employee_type_id" id="" class="form-control">
                                ...
                                <?php $__currentLoopData = $emptype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($employee_type->id); ?>"><?php echo e($employee_type->type); ?></option>
                ...
                <div class="card-body employee-detail-create-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select data-toggle="select2" name="branch_id" id="" class="form-control select2">
                                <option value="">Select department</option>
                                <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select data-toggle="select2" name="department_id" id="" class="form-control select2">
                                <option value="v">Select department</option>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="select2 form-control select2-multiple" id="designation_id" name="designation_id"
                                data-toggle="select2" $designations data-placeholder="<?php echo e(__('Select Designation ...')); ?>">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <div class="float-right col-8">
                                    <input type="text" name="emp_doc_id[<?php echo e($document->id); ?>]"
                                        value="<?php echo e($document->id); ?>">
                                    <div class="choose-file form-group">
                                        <label for="document_<?php echo e($document->id); ?>">
...
unset($__errorArgs, $__bag); ?> border-0"
                                                ...
                                                id="document_<?php echo e($document->id); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/employee/create.blade.php ENDPATH**/ ?>