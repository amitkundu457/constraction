                                    ...
                                    <td>
                                        ...
                                        <td>
                                            ...
                                            <div class="align-items-center">
                                                <span class="completion"><?php echo e($task->taskProgress()['percentage']); ?></span>
                                                <div class="progress">
                                                    <div class="progress-bar bg-<?php echo e($task->taskProgress()['color']); ?>" role="progressbar"
                                                         style="width: <?php echo e($task->taskProgress()['percentage']); ?>;"></div>
                                                </div>
                                            </div>
                                        </td>
...
<?php /**PATH E:\laragon\www\construction\resources\views/project_task/list.blade.php ENDPATH**/ ?>