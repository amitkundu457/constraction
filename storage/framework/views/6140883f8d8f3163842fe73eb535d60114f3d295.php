...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create constant unit')): ?>
            <a href="#" data-url="<?php echo e(route('product-unit.create')); ?>" data-ajax-popup="true"
                data-title="<?php echo e(__('Create New Unit')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
                        ...
                        <table class="table datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th> <?php echo e(__('Unit Code')); ?></th>
                                    <th> <?php echo e(__('Unit Sort Order')); ?></th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($unit->sort_order); ?></td>
                                        <td class="Action">
                                            <span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/productServiceUnit/index.blade.php ENDPATH**/ ?>