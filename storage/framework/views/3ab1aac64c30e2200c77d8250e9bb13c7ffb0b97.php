<?php echo e(Form::open(array('url'=>['agents',$agent->id],'method'=>'put'))); ?>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::text('name',$agent->name,array('class'=>'form-control','placeholder'=>__('Enter Name'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::tel('contact',$agent->contact,array('class'=>'form-control','placeholder'=>__('Enter Contact'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::email('email',$agent->email,array('class'=>'form-control','placeholder'=>__('Enter Email'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::date('dob',$agent->dob,array('class'=>'form-control','placeholder'=>__('Enter DOB'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <?php echo e(Form::label('pan',__('PAN NO.'),['class'=>'form-label'])); ?>

                <?php echo e(Form::text('pan',$agent->pan,array('class'=>'form-control','placeholder'=>__('Enter Pan No'),'required'=>'required'))); ?>
...
<?php /**PATH E:\laragon\www\construction\resources\views/agents/update.blade.php ENDPATH**/ ?>