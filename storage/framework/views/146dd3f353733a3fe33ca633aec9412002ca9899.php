<?php echo e(Form::open(array('url'=>'agents','method'=>'post'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::tel('contact',null,array('class'=>'form-control','placeholder'=>__('Enter Contact'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::date('dob',null,array('class'=>'form-control','placeholder'=>__('Enter DOB'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::text('pan',null,array('class'=>'form-control','placeholder'=>__('Enter Pan No'),'required'=>'required'))); ?>
...
<?php /**PATH E:\laragon\www\construction\resources\views/agents/create.blade.php ENDPATH**/ ?>