...
<?php if(isset($setting['cust_theme_bg']) && $setting['cust_theme_bg'] == 'on'): ?>
    <nav class="dash-sidebar light-sidebar transprent-bg" style="width: 280px">
    <?php else: ?>
...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <?php if(\Auth::user()->type != 'client'): ?>
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                <?php if(Gate::check('manage leave')): ?>
                                    <li class="dash-item <?php echo e(request()->is('leave.index') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('leave.index')); ?>"><?php echo e(__('Leave Management')); ?></a>
                                    </li>
                                <?php endif; ?>
                                        ...
                                        <ul class="dash-submenu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage attendance')): ?>
                                                <li
                                                    ...
                                                    <a class="dash-link"
                                                        href="<?php echo e(route('attendanceemployee.index')); ?>"><?php echo e(__('Attendance')); ?></a>
                                                </li>
                                                <li
                                                ...
                                                <li
                                                    class="dash-item <?php echo e(Request::route()->getName() == 'reports-monthly-attendance' ? 'active' : ''); ?>">
                                                    <a class="dash-link"
                                                        href="<?php echo e(url('reports-monthly-attendance')); ?>"><?php echo e(__('Attendance Report')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage timesheet')): ?>
                                                <li
                                                    class="dash-item <?php echo e(Request::route()->getName() == 'timesheet-list' ? 'active' : ''); ?>">
                                                    <a class="dash-link"
                                                        href="<?php echo e(url('timesheet-list')); ?>"><?php echo e(__('Timesheet')); ?></a>
                                                </li>
                                            <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage company policy')): ?>
                                <li style="display:none"
                                    class="dash-item <?php echo e(request()->is('company-policy*') ? 'active' : ''); ?>">
                                    <a class="dash-link"
                                ...
                                <?php if(Gate::check('manage indicator') || Gate::check('manage appraisal') || Gate::check('manage goal tracking')): ?>
                                    <li style="display:none"
                                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'indicator' || Request::segment(1) == 'appraisal' || Request::segment(1) == 'goaltracking' ? 'active dash-trigger' : ''); ?>"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage event')): ?>
                                    <li style="display:none"
                                        class="dash-item <?php echo e(request()->is('event*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage meeting')): ?>
                                    <li style="display:none"
                                        class="dash-item <?php echo e(request()->is('meeting*') ? 'active' : ''); ?>">
                                        <a class="dash-link"
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            <?php if(Gate::check('manage goal')): ?>
                                <li style="display: none"
                                    class="dash-item <?php echo e(Request::segment(1) == 'goal' ? 'active' : ''); ?>">
                                    <a class="dash-link"
            ...
            <li
                class="dash-item dash-hasmenu
                                    <?php echo e(Request::segment(1) == 'property' ||
                                    ...
                                    Request::segment(1) == 'project_report'
                                        ...
                                        : ''); ?>">
                <a href="#!" class="dash-link"><span class="dash-micon"><i
                            class="ti ti-home"></i></span><span class="dash-mtext"
                        style="12px"><?php echo e(__('Property Management')); ?></span><span class="dash-arrow"><i
                            data-feather="chevron-right"></i></span></a>
                <ul class="dash-submenu">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                        <li
                            class="dash-item  <?php echo e(Request::segment(1) == 'Property' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : ''); ?>">
                            <a class="dash-link" href="<?php echo e(url('property')); ?>"><?php echo e(__('Property')); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task')): ?>
                        <li class="dash-item <?php echo e(request()->is('deal/add*') ? 'active' : ''); ?>">
                            <a class="dash-link" href="<?php echo e(url('deal/add')); ?>"><?php echo e(__('Property Deals')); ?></a>
                        </li>
                    <?php endif; ?>
                    <li
                        class="dash-item  <?php echo e(Request::segment(1) == 'employee' ? 'active dash-trigger' : ''); ?>   ">
                        <?php if(\Auth::user()->type == 'Employee'): ?>
                            ...
                            <a class="dash-link"
                                href="<?php echo e(route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>"><?php echo e(__('Employee')); ?></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('plot.index')); ?>" class="dash-link">
                                <?php echo e(__('Plots')); ?>
                    ...
                    <li
                        ...
                        <?php if(\Auth::user()->type == 'Employee'): ?>
                            ...
                            <a class="dash-link"
                                href="<?php echo e(route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>"><?php echo e(__('Employee')); ?></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('plot.owner.index')); ?>" class="dash-link">
                                <?php echo e(__('Plot Owners')); ?>
                    ...
                    <?php if(Gate::check('manage project task stage') || Gate::check('manage bug status')): ?>
                        <li
                            class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active dash-trigger' : ''); ?>">
                            <a class="dash-link" href="#"><?php echo e(__('Property  Setup')); ?><span
                                    class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task stage')): ?>
                                    <li
                                        ...
                                        <a class="dash-link"
                                            href="<?php echo e(url('property-type')); ?>"><?php echo e(__('Property Type')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task stage')): ?>
                                    <li
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task stage')): ?>
                                    <li
                                        class="dash-item  <?php echo e(Request::route()->getName() == 'project-task-stages.index' ? 'active' : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(url('property-unit')); ?>"><?php echo e(__('Property Unit')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project task stage')): ?>
                                    <li
                        ...
                        <ul
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage lead')): ?>
                                <li
                                    ...
                                    <a class="dash-link" href="<?php echo e(url('leads/list')); ?>"><?php echo e(__('Leads')); ?></a>
                                </li>
                            <?php endif; ?>
            ...
            <?php if(Gate::check('manage project')): ?>
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext"><?php echo e(__('Project Management')); ?></span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage project')): ?>
                            <li
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage bug report')): ?>
                            <li style="display: none"
                                class="dash-item <?php echo e(request()->is('bugs-report*') ? 'active' : ''); ?>">
        ...
        <?php if(
            ...
            <li
                ...
                <ul class="dash-submenu">
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage client')): ?>
                        <li class="dash-item <?php echo e(Request::route()->getName() == 'agents' ? ' active' : ''); ?>">
                            <a class="dash-link" href="<?php echo e(route('agents.index')); ?>"><?php echo e(__('Agent')); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage client')): ?>
                        <li class="dash-item <?php echo e(Request::route()->getName() == 'agency' ? ' active' : ''); ?>">
        ...
        <?php if(Gate::check('manage product & service') || Gate::check('manage product & service')): ?>
            <li
                class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'vender' || Request::segment(1) == 'equipment' ? 'active dash-trigger' : ''); ?>">
                <a href="#!" class="dash-link ">
                ...
                <ul class="dash-submenu">
                    ...
                    <li
                        ...
                        <a class="dash-link" href="#"><?php echo e(__('Equipment Management')); ?><span
                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            <li class="dash-item <?php echo e(request()->is('equipments') ? 'active' : ''); ?>">
                                <a class="dash-link"
            ...
            <?php if(Gate::check('manage customer') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext"><?php echo e(__('Fleet Management ')); ?>
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li
                            class="dash-item <?php echo e(Request::route()->getName() == 'vehicle-expenses.index' ? ' active' : ''); ?>">
                            <a class="dash-link"
                                href="<?php echo e(route('vehicle-expenses.index')); ?>"><?php echo e(__('Income & Expense')); ?></a>
                        </li>
                        <li
                            class="dash-item <?php echo e(Request::route()->getName() == 'vehicle.availability' ? ' active' : ''); ?>"">
                            <a class="dash-link"
                                href="<?php echo e(route('vehicle.availability')); ?>"><?php echo e(__('Availability')); ?></a>
                        </li>
                        ...
                        <li
                            ...
                            <a class="dash-link"
                                href="<?php echo e(route('vehicle.type.index')); ?>"><?php echo e(__('Fleet Setup')); ?></a>
                        </li>
        ...
        <li
            class="dash-item dash-hasmenu
                             <?php echo e(Request::route()->getName() == 'food.product.index' ||
                             Request::route()->getName() == 'food.retailer.index' ||
                             Request::route()->getName() == 'food.manufacturer.index' ||
                             Request::route()->getName() == 'food.distributor.index' ||
                             Request::route()->getName() == 'food.unit.index' ||
                             Request::route()->getName() == 'food.type.index' ||
                             Request::route()->getName() == 'food.area.index'
                                 ? ' active dash-trigger'
                                 : ''); ?>">
            <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-exchange"></i></span><span
                    class="dash-mtext"><?php echo e(__('Supply Chain Management')); ?>

                </span><span class="dash-arrow"><i data-feather="chevron-right"></i></span>
            </a>
            <ul class="dash-submenu">
                <li class="dash-item <?php echo e(Request::route()->getName() == 'food.product.index' ? ' active' : ''); ?>">
                    <a class="dash-link" href="<?php echo e(route('food.product.index')); ?>"><?php echo e(__('Product')); ?></a>
                </li>
                <li class="dash-item <?php echo e(Request::route()->getName() == 'food.retailer.index' ? ' active' : ''); ?>">
                    <a class="dash-link" href="<?php echo e(route('food.retailer.index')); ?>"><?php echo e(__('Retailer')); ?></a>
                </li>
                <li
                    class="dash-item <?php echo e(Request::route()->getName() == 'food.manufacturer.index' ? ' active' : ''); ?>">
                    <a class="dash-link"
                        href="<?php echo e(route('food.manufacturer.index')); ?>"><?php echo e(__('Manufacturer')); ?></a>
                </li>
                <li class="dash-item <?php echo e(Request::route()->getName() == 'food.distributor.index' ? ' active' : ''); ?>">
                    <a class="dash-link" href="<?php echo e(route('food.distributor.index')); ?>"><?php echo e(__('Dristributor')); ?></a>
                </li>
                <li class="dash-item <?php echo e(Request::route()->getName() == 'food.unit.index' ? ' active' : ''); ?>">
                    <a class="dash-link" href="<?php echo e(route('food.unit.index')); ?>"><?php echo e(__('Supply Setup')); ?></a>
                </li>
            </ul>
        </li>
        <!--------------------- End Food Management ----------------------------------->
        ...
        <li style="display: none;" class="dash-item dash-hasmenu
            ...
            <ul class="dash-submenu">
                <li class="dash-item">
                    <a class="dash-link" href="#"><?php echo e(__('Quality Plans')); ?></a>
                </li>
                <li class="dash-item ">
                    <a class="dash-link" href=""><?php echo e(__('Quality Audits')); ?></a>
                </li>
        ...
        <?php if(\Auth::user()->type != 'super admin'): ?>
            ...
            <li style="display: none"
                class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'chats' ? 'active' : ''); ?>">
        ...
        <div class="navbar-footer border-top " style="display: none">
            <div class="d-flex align-items-center py-4 px-3 border-bottom">
                <div class="me-2">
...
<?php /**PATH E:\laragon\www\construction\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>