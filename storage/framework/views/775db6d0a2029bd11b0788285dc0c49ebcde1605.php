...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('plot.create')); ?>" class="mt-3" method="post" x-data="{ owner: null, getOwner(id) { fetch(`/plot/owner/${id}`).then((res) => res.json()).then((data) => this.owner = data.owner) } }"
            ...
            <div class="form-group col-md-4">
                ...
                <select name="owner_id" x-on:change="getOwner($event.target.value)" id="" class="form-control">
                    ...
                    <?php $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $own): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($own->id); ?>"><?php echo e($own->name); ?></option>
            ...
            <div class="form-group col-md-6">
                ...
                <select name="project_id" id="" class="form-control">
                    ...
                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($proj->id); ?>"><?php echo e($proj->project_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="form-group col-md-6">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <template x-if="owner.documents[index].type == 'document'">
                                            <a :href="'/plot/' + owner.documents[index].file"
                                                :download="owner.documents[index].file" style="font-size:15px;"
                                                x-text="owner.documents[index].file"></a>
                                        </template>
        ...
        <div class="row" x-data="{ dispute: false }">
                ...
                <div class="form-group">
                    ...
                    <div class="my-3">
                        <div class="form-check">
                            <input class="form-check-input" x-on:change="dispute = true" name="is_dispute"
                                type="radio" checked="dispute">
                            <label class="form-check-label" style="font-weight: 500">
                                Yes
                            </label>
                        </div>
                        <div class="form-check mt-2">
                            <input class="form-check-input" x-on:change="dispute = false" name="is_dispute"
                                type="radio" checked="!dispute">
            ...
            <div class="col-md-6">
                <div x-show="dispute" class="form-group">
                    ...
                    <textarea name="notes" id="" class="form-control" cols="3" rows="5" style="width: 100%"></textarea>
                </div>
                    ...
                    <tbody>
                        ...
                        <template x-for="(index,plot) in plots">
                            <tr x-data="{ total: 0, area: 0, price: 0 }">
                                ...
                                <td>
                                    <input type="text" :name="`plots[${index}][name]`" class="form-control"
                                        placeholder="Enter plot name">
                                </td>
                                <td>
                                    <input type="text" :name="`plots[${index}][location]`" class="form-control"
                                        placeholder="Enter plot location">
                                </td>
                                <td>
                                    <input type="number" :name="`plots[${index}][area]`"
                                        x-on:input="area = $event.target.value" class="form-control"
                                        placeholder="Enter plot area">
                                </td>
                                <td>
                                    <input type="number" :name="`plots[${index}][price]`"
                                        x-on:input="price = $event.target.value" class="form-control"
                                        placeholder="Enter plot price">
                                </td>
                                <td>
                                    <input type="number" :name="`plots[${index}][total_amount]`"
                                        x-bind:value="area * price" class="form-control"
                                        placeholder="Enter plot amount">
                                </td>
                                <td>
