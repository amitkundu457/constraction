...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Site-Detail')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><a href="<?php echo e(route('vender.index')); ?>"><?php echo e(__('site')); ?></a></li>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create bill')): ?>
            <a data-bs-target="#exampleModal" data-bs-toggle="modal" class="btn btn-sm btn-primary">
                <?php echo e(__('Add Stage')); ?>

            </a>
        <?php endif; ?>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit vender')): ?>
            <a href="#" class="btn btn-sm btn-primary" data-size="xl" data-url="<?php echo e(route('vender.edit', $vendor['id'])); ?>"
                data-ajax-popup="true" title="<?php echo e(__('Edit')); ?>" data-bs-toggle="tooltip"
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete vender')): ?>
            ...
            <a href="#" class="btn btn-sm btn-danger bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>"
                data-original-title="<?php echo e(__('Delete')); ?>"
                data-confirm="<?php echo e(__('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?')); ?>"
                data-confirm-yes="document.getElementById('delete-form-<?php echo e($vendor['id']); ?>').submit();">
            ...
            <div class="card pb-0 customer-detail-box vendor_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">
                        <?php echo e($vendor->billing_city . ', ' . $vendor->billing_state . ', ' . $vendor->billing_zip); ?></p>
        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="card pb-0 customer-detail-box vendor_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">
                        <?php echo e($vendor->shipping_city . ', ' . $vendor->shipping_state . ', ' . $vendor->shipping_zip); ?></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="p-4">
                                ...
                                <h6 class="report-text mb-3"><?php echo e(\Auth::user()->venderNumberFormat($vendor->vender_id)); ?>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="p-4">
                                ...
                                <h6 class="report-text mb-3">
                                    <?php echo e(\Auth::user()->priceFormat($vendor->vendorOverdue($vendor->id))); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="font-style">
                                        <td class="Id">
                                            <a href="<?php echo e(route('bill.show', \Crypt::encrypt($bill->id))); ?>"
                                                class="btn btn-outline-primary"><?php echo e(AUth::user()->billNumberFormat($bill->bill_id)); ?>
                                        ...
                                        <td>
                                            <?php if($bill->due_date < date('Y-m-d')): ?>
                                                <p class="text-danger"> <?php echo e(\Auth::user()->dateFormat($bill->due_date)); ?>
                                        ...
                                        <td>
                                            <?php if($bill->status == 0): ?>
                                                <span
                                                    class="badge bg-primary p-2 px-3 rounded"><?php echo e(__(\App\Models\Invoice::$statues[$bill->status])); ?></span>
                                            <?php elseif($bill->status == 1): ?>
                                                <span
                                                    class="badge bg-warning p-2 px-3 rounded"><?php echo e(__(\App\Models\Invoice::$statues[$bill->status])); ?></span>
                                            <?php elseif($bill->status == 2): ?>
                                                <span
                                                    class="badge bg-danger p-2 px-3 rounded"><?php echo e(__(\App\Models\Invoice::$statues[$bill->status])); ?></span>
                                            <?php elseif($bill->status == 3): ?>
                                                <span
                                                    class="badge bg-info p-2 px-3 rounded"><?php echo e(__(\App\Models\Invoice::$statues[$bill->status])); ?></span>
                                            <?php elseif($bill->status == 4): ?>
                                                <span
                                                    class="badge bg-success p-2 px-3 rounded"><?php echo e(__(\App\Models\Invoice::$statues[$bill->status])); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <?php if(Gate::check('edit bill') || Gate::check('delete bill') || Gate::check('show bill')): ?>
                                            <td class="Action">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete bill')): ?>
                                                        <div class="action-btn bg-danger ms-2">
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                data-confirm="<?php echo e(__('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?')); ?>"
                                                                data-confirm-yes="document.getElementById('delete-form-<?php echo e($bill->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/vender/show.blade.php ENDPATH**/ ?>