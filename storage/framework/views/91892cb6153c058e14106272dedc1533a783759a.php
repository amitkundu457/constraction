...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            ...
            <a href="<?php echo e(Storage::url('uploads/sample/sample-employee.csv')); ?>" download="sample-employee.csv" class="btn btn-sm btn-primary">
...
<?php /**PATH E:\laragon\www\construction\resources\views/employee/import.blade.php ENDPATH**/ ?>