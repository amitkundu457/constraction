...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Property Unit')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Property Unit')); ?></li>
<?php $__env->stopSection(); ?>
                ...
                <table class="table table-striped custom-table mb-0">
                    ...
                    <tbody>
                        <?php
                            $count = 1;
                        ?>
                        <?php $__currentLoopData = $unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(url('property-unit-update', $propertie->id)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input value="<?php echo e($propertie->unit_name); ?>" type="text"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <form action="<?php echo e(url('property-unit-delete', $propertie->id)); ?>"
                                                        method="get">
        ...
        <div class="modal custom-modal fade" id="callstore" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(url('property-unit-store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/property/propertyUnit.blade.php ENDPATH**/ ?>