    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::select('role', $roles, null, ['class' => 'form-control select'])); ?>
...
<?php /**PATH E:\laragon\www\construction\resources\views/documentUpload/create.blade.php ENDPATH**/ ?>