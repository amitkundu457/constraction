...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" data-url="<?php echo e(URL::to('leads/' . $lead->id . '/labels')); ?>" data-ajax-popup="true" data-size="lg"
            data-bs-toggle="tooltip" title="<?php echo e(__('Label')); ?>" class="btn btn-sm btn-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-muted text-sm mb-0"><?php echo e(__('Lead Stage')); ?></p>
                                ...
                                <div class="col-md-4 col-sm-4 mt-4">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-muted text-sm mb-0"><?php echo e(__('Lead Status')); ?></p>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h5 class="mb-0 text-warning">
                                                <?php echo e(\Auth::user()->dateFormat($lead->created_at)); ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 mt-4">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <div class="progress mb-0">
                                                <div class="progress-bar bg-info" style="width: <?php echo e($precentage); ?>%;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/leads/show.blade.php ENDPATH**/ ?>