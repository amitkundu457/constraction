...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('from_warehouse', __('From Site'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('to_warehouse',__('To Site'),array('class'=>'form-label'))); ?><span class="text-danger">*</span>
        ...
        <div class="form-group col-md-6" id="product_div">
            <?php echo e(Form::label('product',__('Material'),array('class'=>'form-label'))); ?>
...
<?php /**PATH E:\laragon\www\construction\resources\views/warehouse-transfer/create.blade.php ENDPATH**/ ?>