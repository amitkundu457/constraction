                                    ...
                                    <tr>
                                        <td class="Id">
                                            <a href="<?php echo e(route('purchase.show', \Crypt::encrypt($purchase->id))); ?>"
                                                class="btn btn-outline-primary"><?php echo e(Auth::user()->purchaseNumberFormat($purchase->purchase_id)); ?></a>
                                        ...
                                        <td>
                                            <?php if($purchase->status == 0): ?>
                                                <span
                                                    class="purchase_status badge bg-secondary p-2 px-3 rounded"><?php echo e(__(\App\Models\Purchase::$statues[$purchase->status])); ?></span>
                                            <?php elseif($purchase->status == 1): ?>
                                                <span
                                                    class="purchase_status badge bg-warning p-2 px-3 rounded"><?php echo e(__(\App\Models\Purchase::$statues[$purchase->status])); ?></span>
                                            <?php elseif($purchase->status == 2): ?>
                                                <span
                                                    class="purchase_status badge bg-danger p-2 px-3 rounded"><?php echo e(__(\App\Models\Purchase::$statues[$purchase->status])); ?></span>
                                            <?php elseif($purchase->status == 3): ?>
                                                <span
                                                    class="purchase_status badge bg-info p-2 px-3 rounded"><?php echo e(__(\App\Models\Purchase::$statues[$purchase->status])); ?></span>
                                            <?php elseif($purchase->status == 4): ?>
                                                <span
                                                    class="purchase_status badge bg-primary p-2 px-3 rounded"><?php echo e(__(\App\Models\Purchase::$statues[$purchase->status])); ?></span>
                                            <?php endif; ?>
                                        </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/purchase/index.blade.php ENDPATH**/ ?>