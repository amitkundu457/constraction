<?php echo e(Form::open(['route' => ['productservice.import'], 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            ...
            <a href="<?php echo e(Storage::url('uploads/sample/sample-product.csv')); ?>"
                download="sample-product.csv" class="btn btn-sm btn-primary">
...
<?php /**PATH E:\laragon\www\construction\resources\views/productservice/import.blade.php ENDPATH**/ ?>