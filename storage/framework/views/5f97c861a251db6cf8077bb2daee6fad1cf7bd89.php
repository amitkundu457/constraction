...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Property BHK')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Property BHK')); ?></li>
<?php $__env->stopSection(); ?>
...
<script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.14.1/dist/cdn.min.js"></script>
    <div class="row">
        <div class="col-md-6">
            <form action="<?php echo e(url('property-bhk-store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal-dialog modal modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Property BHK <?php echo e($amenity->id); ?></h5>
                                                ...
                                                <div class="modal-body text-start">
                                                    <form action="<?php echo e(url('property-bhk-update', $amenity->id)); ?>"
                                                        method="post" >
                                                        <?php echo csrf_field(); ?>
                                                        <div class="form-group">
                                                            <label>Name <span class="text-danger">*</span></label>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <form action="<?php echo e(url('property-bhk-delete', $amenity->id)); ?>"
                                                        method="post">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/property/propertyBhk.blade.php ENDPATH**/ ?>