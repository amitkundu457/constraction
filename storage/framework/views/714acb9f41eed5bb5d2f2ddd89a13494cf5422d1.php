                                        ...
                                        <td>
                                            <?php if(!empty($productService->tax_id)): ?>
                                                ...
                                                <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span
                                                        class=""><?php echo e(!empty($tax) ? $tax->name : '' . ' (' . $tax->rate . '%)'); ?></span><br>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit product & service')): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center"
                                                            ...
                                                            title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Product')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/productservice/index.blade.php ENDPATH**/ ?>