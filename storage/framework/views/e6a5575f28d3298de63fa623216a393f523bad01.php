<?php echo e(Form::open(['route' => ['plot.owner.update',$owner->id], 'method' => 'put','enctype'=>'multipart/form-data'])); ?>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::text('name', $owner->name, ['class' => 'form-control', 'placeholder' => __('Enter Name'), 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::tel('phone', $owner->name, ['class' => 'form-control', 'placeholder' => __('Enter Phone'), 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo e(Form::text('location', $owner->location, ['class' => 'form-control', 'placeholder' => __('Enter City'), 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('state', $owner->state, ['class' => 'form-control', 'placeholder' => __('Enter State'), 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <?php echo e(Form::text('adhaar', $owner->adhaar, ['class' => 'form-control', 'placeholder' => __('Enter Adhaar No'), 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('address', $owner->address, ['class' => 'form-control', 'placeholder' => __('Enter owner address'), 'required' => 'required', 'rows' => '2'])); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-12">
            <div class=" row" x-data="{ files: <?php echo e(count($owner->documents)); ?>, docs: <?php echo e(json_encode($owner->documents)); ?> }">
...
<?php /**PATH E:\laragon\www\construction\resources\views/plot/updateOwner.blade.php ENDPATH**/ ?>