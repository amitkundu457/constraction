...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Edit Word Document')); ?>
...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('word.edit', $word->id)); ?>" method="POST" enctype="multipart/form-data" id="word">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-12 shadow my-3">
                ...
                <div class="d-flex justify-content-between align-items-center py-4 px-3">
                    ...
                    <div class="">
                        <input type="text" name="name" class="form-control" placeholder="Save file as"
                            value="<?php echo e($word->name); ?>" required>
                    </div>
                    <div class="">
                ...
                <div class="d-flex justify-content-between align-items-center px-5 my-2" x-data="loadPreview()">
                    <div class="d-flex flex-column align-items-center px-3">
                        <input type="file" x-on:change="change($event,'left')" name="sig_sender" class="d-none"
                            id="left">
                            <input type="text" class="form-control" name="ltext" placeholder="enter text" value="<?php echo e($word->ltext); ?>">
                    ...
                    <div class="d-flex flex-column align-items-center px-3">
                        <input type="file" x-on:change="change($event,'right')" name="sig_receiver" class="d-none"
                            id="right">
                            <input type="text" class="form-control" name="rtext" placeholder="enter text" value="<?php echo e($word->rtext); ?>">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        function loadPreview() {
            return {
                limage: <?php echo json_encode($word->sig_sender ? Storage::disk('public')->url($word->sig_sender) : null, 15, 512) ?>,
                rimage: <?php echo json_encode($word->sig_receiver ? Storage::disk('public')->url($word->sig_receiver) : null, 15, 512) ?>,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\construction\resources\views/word/update.blade.php ENDPATH**/ ?>