...
class AttendanceEmployeeController extends Controller
{
    ...
    public function AttandeceReport(Request $request)
    {
        ...
        // Fetch the records between the specified dates
        $atten = AttendanceEmployee::whereBetween('created_at', [$startDate, $endDate])->get();




        return view('attendance.report', compact('atten'));
    }
}
