...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        if (\Auth::user()->can('create employee')) {
            ...
            $emptype = EmployeType::all();

            return view('employee.create', compact('employees', 'employeesId', 'departments', 'designations', 'documents', 'branches', 'company_settings', 'emptype'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    {
        $emtype = EmployeType::all();
        return view('employee/emptype', compact('emtype'));
    }
    ...
    public function employeeCreate(Request $request)
    {
        ...
        $emp->save();
        return redirect()->back()->with('success', 'Employee Type Added Successfully');
    }
