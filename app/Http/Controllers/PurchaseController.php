...
class PurchaseController extends Controller
{
    ...
    public function create($vendorId)
    {
        if (\Auth::user()->can('create purchase')) {
            ...
            return view('purchase.create', compact('venders', 'expenseChartAccounts', 'purchase_number', 'product_services', 'category', 'customFields', 'vendorId', 'warehouse', 'company'));
        } else {
