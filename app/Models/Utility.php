...
//                    dd(\Storage::disk(),$path);
    ...
    public static function trialBalance($account_id, $start, $end)
    {
        ...
        $invoicePayment = InvoicePayment::select('chart_of_accounts.id','chart_of_accounts.code','chart_of_accounts.name' , \DB::raw('0 as totalDebit'), \DB::raw('sum(amount) as totalCredit'));
